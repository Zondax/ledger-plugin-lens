...
ICONNAME=icons/nanos_app_lens.gif
else ifeq ($(TARGET_NAME), TARGET_STAX)
ICONNAME=icons/stax_app_lens.gif
DEFINES += ICONGLYPH=C_stax_lens_64px
DEFINES += ICONBITMAP=C_stax_lens_64px_bitmap
GLYPH_FILES += $(ICONNAME)
else
ICONNAME=icons/nanox_app_lens.gif
endif
